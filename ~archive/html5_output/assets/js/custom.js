...
$(function(){
    ...
    $(pre_lbs_input).keyup(function(){
        ...
        pre_lbs_times5 = pre_lbs_input_value * Number(5) / Number(2.205);
        pre_lbs_times5_output = '.pre_lbs_times5';
        $(pre_lbs_times5_output).html( Math.ceil(pre_lbs_times5) );

        pre_lbs_times7 = pre_lbs_input_value * Number(7) / Number(2.205);
        pre_lbs_times7_output = '.pre_lbs_times7';
        $(pre_lbs_times7_output).html( Math.ceil(pre_lbs_times7) );

        pre_lbs_times3 = pre_lbs_input_value * Number(3) / Number(2.205);
